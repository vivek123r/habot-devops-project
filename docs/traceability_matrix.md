...
| S.3.a | "architectural overview and logic flow using a Google Slides or PowerPoint presentation (Maximum of 15 slides)" | Twelve-slide deck | `Presentation/Vivek_R_HabotConnect_Presentation.pdf` |
